;; Generated by :claw at 2023-09-15T00:19:02.752467Z
...
(defparameter %nanovg::+gl-generate-mipmap+ 33169)

(defparameter %nanovg::+gl-luminance+ 6409)

(defparameter %nanovg::+nanovg-gl2+ 1)
...
(cffi:defbitfield (%nanovg::align :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:74:6"
  (:left 1)
  (:center 2)
  (:right 4)
  (:top 8)
...
(cffi:defbitfield (%nanovg::blend-factor :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:86:6"
  (:zero 1)
  (:one 2)
  (:src-color 4)
...
(cffi:defcenum (%nanovg::composite-operation :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:100:6"
  (:source-over 0)
  (:source-in 1)
  (:source-out 2)
  (:atop 3)
...
(cffi:defbitfield (%nanovg::create-flags :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg_gl.h:27:6"
  (:antialias 1)
  (:stencil-strokes 2)
  (:debug 4))

(cffi:defbitfield (%nanovg::image-flags :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:138:6"
  (:generate-mipmaps 1)
  (:repeatx 2)
  (:repeaty 4)
  (:flipy 8)
...
(cffi:defbitfield (%nanovg::image-flags-gl :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg_gl.h:98:6"
  (:image-nodelete 65536))

(cffi:defcenum (%nanovg::line-cap :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:66:6"
  (:butt 0)
  (:round 1)
  (:square 2)
  (:bevel 3)
...
(cffi:defbitfield (%nanovg::solidity :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:61:6"
  (:solid 1)
  (:hole 2))

(cffi:defbitfield (%nanovg::texture :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:618:6"
  (:alpha 1)
  (:rgba 2))

(cffi:defbitfield (%nanovg::winding :unsigned-int)
  "/home/fitzsim/quicklisp/local-projects/bodge-nanovg/src/lib/nanovg/src/nanovg.h:56:6"
  (:ccw 1)
  (:cw 2))
...
(cffi:defcfun ("nvgAddFallbackFont" %nanovg::add-fallback-font)
    :int
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context))
...
(cffi:defcunion (%nanovg::|C:@S@NV-GCOLOR@UA| :size 16)
  ...
  (%nanovg::@0 (:struct %nanovg::|C:@S@NV-GCOLOR@UA@SA|)))

(cffi:defcstruct (%nanovg::color :size 16)
  (%nanovg::@0 (:union %nanovg::|C:@S@NV-GCOLOR@UA|) :offset 0))
...
(cffi:defcfun ("__claw_nvgBoxGradient" %nanovg::box-gradient)
  ...
  (%nanovg::%%claw-result- (claw-utils:claw-pointer %nanovg::paint))
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context))
  (%nanovg::x :float)
  (%nanovg::y :float)
  (%nanovg::w :float)
  ...
  (%nanovg::r :float)
  (%nanovg::f :float)
  (%nanovg::icol (claw-utils:claw-pointer %nanovg::color))
  (%nanovg::ocol (claw-utils:claw-pointer %nanovg::color)))
...
(cffi:defcfun ("nvgCreateFontMem" %nanovg::create-font-mem)
  ...
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context))
  (%nanovg::name claw-utils:claw-string)
  (%nanovg::data (claw-utils:claw-pointer :unsigned-char))
  (%nanovg::ndata :int)
...
(cffi:defcstruct (%nanovg::params :size 112)
  (%nanovg::user-ptr (claw-utils:claw-pointer :void) :offset 0)
  (%nanovg::edge-anti-alias :int :offset 8)
  (%nanovg::render-create (claw-utils:claw-pointer :void) :offset 16)
  (%nanovg::render-create-texture (claw-utils:claw-pointer :void) :offset 24)
  (%nanovg::render-delete-texture (claw-utils:claw-pointer :void) :offset 32)
  (%nanovg::render-update-texture (claw-utils:claw-pointer :void) :offset 40)
  (%nanovg::render-get-texture-size (claw-utils:claw-pointer :void) :offset 48)
  (%nanovg::render-viewport (claw-utils:claw-pointer :void) :offset 56)
  (%nanovg::render-cancel (claw-utils:claw-pointer :void) :offset 64)
  (%nanovg::render-flush (claw-utils:claw-pointer :void) :offset 72)
  (%nanovg::render-fill (claw-utils:claw-pointer :void) :offset 80)
  (%nanovg::render-stroke (claw-utils:claw-pointer :void) :offset 88)
  (%nanovg::render-triangles (claw-utils:claw-pointer :void) :offset 96)
  (%nanovg::render-delete (claw-utils:claw-pointer :void) :offset 104))
...
(cffi:defcfun ("nvgCreateInternal" %nanovg::create-internal)
    (claw-utils:claw-pointer %nanovg::context)
  (%nanovg::params (claw-utils:claw-pointer %nanovg::params)))
...
(cffi:defcfun ("nvgDebugDumpPathCache" %nanovg::debug-dump-path-cache)
    :void
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context)))
...
(cffi:defcfun ("__claw_nvgFillColor" %nanovg::fill-color)
    :void
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context))
  (%nanovg::color (claw-utils:claw-pointer %nanovg::color)))
...
(cffi:defcfun ("__claw_nvgFillPaint" %nanovg::fill-paint)
    :void
  (%nanovg::ctx (claw-utils:claw-pointer %nanovg::context))
  (%nanovg::paint (claw-utils:claw-pointer %nanovg::paint)))
...
(cffi:defcfun ("__claw_nvgHSL" %nanovg::hsl)
  ...
  (%nanovg::%%claw-result- (claw-utils:claw-pointer %nanovg::color))
  (%nanovg::h :float)
  (%nanovg::s :float)
  (%nanovg::l :float))
...
(cffi:defcfun ("nvgTextBreakLines" %nanovg::text-break-lines)
  ...
  (%nanovg::end claw-utils:claw-string)
  (%nanovg::break-row-width :float)
  (%nanovg::rows (claw-utils:claw-pointer %nanovg::text-row))
  (%nanovg::max-rows :int))
...
(cffi:defctype %nanovg::glyph-position (:struct %nanovg::glyph-position))
...
(cffi:defcfun ("nvgTextGlyphPositions" %nanovg::text-glyph-positions)
  ...
  (%nanovg::string claw-utils:claw-string)
  (%nanovg::end claw-utils:claw-string)
  (%nanovg::positions (claw-utils:claw-pointer %nanovg::glyph-position))
...
(cffi:defcstruct (%nanovg::path :size 56)
  ...
  (%nanovg::fill (claw-utils:claw-pointer %nanovg::vertex) :offset 16)
  (%nanovg::nfill :int :offset 24)
  (%nanovg::stroke (claw-utils:claw-pointer %nanovg::vertex) :offset 32)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%nanovg::+gl-generate-mipmap+ :%nanovg)
  (export '%nanovg::+gl-luminance+ :%nanovg)
  (export '%nanovg::+nanovg-gl2+ :%nanovg)
  ...
  (setf (getf (symbol-plist '%nanovg::@0) :cffi-c-ref-anonymous-field) t))
